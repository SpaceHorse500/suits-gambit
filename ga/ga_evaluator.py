...
class PopulationEvaluator:
    """
    Fitness uses ONLY:
      • win_rate  (primary & decisive)

    Everything else (median, Q1, Q3, sd, iqr, bust_rate, etc.)
    is computed purely for diagnostics/logging.
    """
    ...
    def evaluate_all_in_one(
        ...
        min_score: List[Optional[int]] = [None for _ in range(P)]
        ...
        ctrl_min: Dict[str, Optional[int]] = {n: None for n in ctrl_names}
        ...
        for i in range(P):
            ...
            # NOTE: median/q1/q3 duplicated into diagnostics so the current runner prints them.
            fits.append(Fitness(
                win_rate=wr,
                median=med,
                q1=q1,
